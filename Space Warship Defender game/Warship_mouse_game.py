...
# Title and Icon
pygame.display.set_caption("Space Warship Defender (Mouse Controls)")
...
def game_over_screen():
    ...
    restart_text = restart_font.render("Click anywhere to restart", True, (255, 255, 255))
...
def reset_game():
    global player_x, player_y, bullet_state, bullet_y, score_value, game_over
    global enemy_x, enemy_y, show_explosion
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEMOTION and not game_over:
            # Move player ship with mouse X position
